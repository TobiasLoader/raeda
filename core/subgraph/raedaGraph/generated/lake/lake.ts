...
export class lake__checkBucketResult {
  value0: BigInt;
  value1: boolean;
  value2: string;
...
export class lake__collectionResult {
  ...
  value2: Address;
  value3: BigInt;
  value4: lake__collectionResultIXStruct;
  value5: lake__collectionResultFXStruct;
  value6: BigInt;
  value7: BigInt;
  value8: BigInt;
  value9: boolean;
...
export class lake extends ethereum.SmartContract {
  ...
  bids(param0: BigInt, param1: BigInt): lake__bidsResult {
  ...
  try_bids(
    param0: BigInt,
    param1: BigInt
  ): ethereum.CallResult<lake__bidsResult> {
  ...
  checkBucket(_postId: BigInt, _category: string): lake__checkBucketResult {
    let result = super.call(
      "checkBucket",
    ...
    return new lake__checkBucketResult(
      result[0].toBigInt(),
      result[1].toBoolean(),
      result[2].toString()
    );
  ...
  try_checkBucket(
    _postId: BigInt,
    _category: string
  ): ethereum.CallResult<lake__checkBucketResult> {
    let result = super.tryCall(
      "checkBucket",
      "checkBucket(uint32,string):(uint32,bool,string)",
      [
  ...
  collection(param0: BigInt): lake__collectionResult {
    let result = super.call(
      "collection",
    ...
    return new lake__collectionResult(
      ...
      result[2].toAddress(),
      result[3].toBigInt(),
      changetype<lake__collectionResultIXStruct>(result[4].toTuple()),
      changetype<lake__collectionResultFXStruct>(result[5].toTuple()),
      result[6].toBigInt(),
      result[7].toBigInt(),
      result[8].toBigInt(),
      result[9].toBoolean(),
  ...
  try_collection(param0: BigInt): ethereum.CallResult<lake__collectionResult> {
    let result = super.tryCall(
      "collection",
      "collection(uint32):(string,uint32,address,uint256,(uint32,uint32),(uint32,uint32),uint32,uint32,uint32,bool,uint32)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
    ...
    return ethereum.CallResult.fromValue(
      new lake__collectionResult(
        ...
        value[2].toAddress(),
        value[3].toBigInt(),
        changetype<lake__collectionResultIXStruct>(value[4].toTuple()),
        changetype<lake__collectionResultFXStruct>(value[5].toTuple()),
        value[6].toBigInt(),
        value[7].toBigInt(),
        value[8].toBigInt(),
        value[9].toBoolean(),
